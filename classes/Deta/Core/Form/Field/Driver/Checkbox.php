 ...
 * Checkbox field.
 *
 * Note it must extend Deta_Core_Form_Field_Multiple since it allows multiple possibilities.
 *
 * @package Deta
 ...
 */
class Deta_Core_Form_Field_Driver_Checkbox extends Deta_Core_Form_Field_Multiple {
